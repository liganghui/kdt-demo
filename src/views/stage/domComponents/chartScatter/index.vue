...
export default {
    ...
    data() {
        return {
            config: {
                // Scatter Plot
                symbolShape: 'circle', // Scatter Shape，Optional Values：'circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none'
                symbolSize: 10, // Scatter Size
                // General Configuration Parameters（Keep Original Configuration）
                showTitle: true,
